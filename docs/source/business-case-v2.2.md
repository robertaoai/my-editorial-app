...
> **Document version:** 2.2 — Citation fix + OD3 scope correction
> **Date:** 2026-08-16
...
- Zero articles bypass review **independence** (four-eyes at Line boundaries: unconditional — satisfied by Line separation per Three Lines Model)
