...
- **Verified-By:** Lane B — independently confirmed raw marker detection, the corrected filled-Evidence rule, and the six negative fixtures plus positive control
- **Resolution:** Verified
