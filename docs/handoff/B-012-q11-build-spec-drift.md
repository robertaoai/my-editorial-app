...
- **Kind:** spec-defect
- **Phase:** 1
- **Blocks:** Build Spec drift resolved; the surviving S1 decision window is refiled as `B-029`
- **Status:** Answered
...
- **Resolution:** Verified
- **Verified-By:** Lane B
- **Evidence:** `V1-BUILD-SPEC.md` Q11 paragraph replaced with the decided three-value shape; naming half stated separately as open; the stale *specified, not applied* sentence corrected. The remaining `0002` gate is carried by `B-029`, not silently closed by this verification
