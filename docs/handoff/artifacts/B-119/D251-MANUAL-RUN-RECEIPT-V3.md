...
- **Applied migrations:**
- **Execution role:**
- **Preflight artifact:** `PREFLIGHT-D251-CANDIDATE-COLUMNS-V3.sql.md`
- **Preflight Lane-A-Accepted-Blob-SHA256:**
- **Preflight Executed-SHA256:**
- **Assessment artifact:** `QRY-D251-STORED-VALUE-ASSESSMENT-V5.sql.md`
...
| Result-set name | Returned row count | Complete unchanged output attached below? |
|---|---:|---|
| `CATALOG-VALIDATION` | | yes / no |
| `RECONCILIATION` | | yes / no |
| `VISIBILITY` | | yes / no |
| `ASSESSMENT` | | yes / no / not run |
