...
-- Allowed-Special-Forms: COLLATE, FILTER, GROUP BY, NULLS FIRST
-- Allowed-Operators: = (pg_catalog.text, pg_catalog.text) -> pg_catalog.bool; = (public.gate_role, public.gate_role) -> pg_catalog.bool
-- Allowed-Casts: unknown -> pg_catalog.jsonpath (I/O); unknown -> pg_catalog.text (I/O); unknown -> public.gate_role (I/O)
