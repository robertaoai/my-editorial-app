...
-- Advisory-Operators: = (pg_catalog.name, pg_catalog.name) -> pg_catalog.bool; = (pg_catalog.oid, pg_catalog.oid) -> pg_catalog.bool; = (pg_catalog.text, pg_catalog.text) -> pg_catalog.bool; = (pg_catalog."char", pg_catalog."char") -> pg_catalog.bool; <> (pg_catalog.text, pg_catalog.text) -> pg_catalog.bool; <> (pg_catalog.oid, pg_catalog.oid) -> pg_catalog.bool; > (pg_catalog.int2, pg_catalog.int4) -> pg_catalog.bool; AND (pg_catalog.bool, pg_catalog.bool) -> pg_catalog.bool; NOT (missing, pg_catalog.bool) -> pg_catalog.bool; OR (pg_catalog.bool, pg_catalog.bool) -> pg_catalog.bool; || (pg_catalog.text, pg_catalog.text) -> pg_catalog.text
