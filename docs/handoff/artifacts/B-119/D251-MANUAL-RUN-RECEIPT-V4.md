...
- **Applied migrations:**
- **Execution role:**
- **Preflight artifact:** `PREFLIGHT-D251-CANDIDATE-COLUMNS-V4.sql.md`
- **Preflight Lane-A-Accepted-Blob-SHA256:**
- **Preflight Executed-SHA256:**
- **Assessment artifact:** `QRY-D251-STORED-VALUE-ASSESSMENT-V6.sql.md`
