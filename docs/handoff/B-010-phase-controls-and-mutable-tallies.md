...
- **Resolution:** Applied
- **Examined-By:** Lane B — **REJECTED**, see `B-025`: the `C-19` negative-test evidence it cites was never tracked. It stays `Applied` because no `Rejected` resolution exists yet (`D-105` P2, drafted not built); **the rejection is the linked entry, not this field** (`D-108`)
