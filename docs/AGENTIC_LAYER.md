...
> scope and evidence read `docs/fn-specs/FN-GATES-01-05.md` and the Register's current/target executor and Line contract. **Historical agent-tool descriptions supply no transition authority.**
