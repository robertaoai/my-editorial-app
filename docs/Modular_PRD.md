...
| S2 | Line assignment and independence | O-03 ⚠ | FR-04, FR-05 | NFR-03, SEC-01 | AC-05…AC-08 | P0 | `Q12`/`Q1` Phase-0 closed (`D-163`) — Unit 1 authorized (`D-164`/`D-165`), not started; Unit 2 not authorized |
