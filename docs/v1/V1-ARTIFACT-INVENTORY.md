...
| `docs/v1/V1-B071-CORRECTIVE-PLAN.md` | `B-071` | ✅ **Created 2026-09-02, revised 2026-09-02 incorporating `B071-R8`–`R14`.** Draft implementation plan consolidating `B-071`'s T5/T6 ontology correction for independent review and Judge approval (Gate A). Supports one correction, not a standing tracker — retire or mark historical once `D-182` is recorded and propagated (`B071-R8`). |
