...
|---|---|---|
| `scripts/fixtures/` | `D-106`, `G80` | ✅ **Created 2026-08-24.** The negative fixtures, `bun run fixtures` — six suites, thirty fixtures. **Fourteen claims of "negative-tested N ways" existed with no fixture in the repository**, and §6.4d told the reader to run one from a session scratchpad. Positive control per suite; asserts the intended finding, not merely a failure; refuses a dirty tree |
